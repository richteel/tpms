...
#if defined(ARDUINO_ESP32_DEV) || defined(ARDUINO_FEATHER_ESP32) || defined(ARDUINO_CoreESP32) || defined(ARDUINO_FEATHER_ESP32) || defined (ARDUINO_D1_MINI32)
...
const uint32_t  IDLookup[] =
{
  ...
  const unsigned char PROGMEM CRC8_Poly_2F_crctable2[] =
  {
...
//      };
    ...
    const uint16_t TestTimings[] =
      {
         51, 52, 53, 53, 52, 54, 50, 53, 52, 52, 52, 53, 52, 52, 52, 53, 54, 51, 52, 
         52, 52, 54, 51, 51, 53, 54, 53, 52, 50,105, 53, 54, 53, 51,104, 52, 53, 52, 
         53, 52, 52, 52, 55, 51, 51, 53, 52, 53, 52, 53, 54, 50, 52, 52, 54, 51, 52, 
         52, 51, 52, 52, 53, 53, 54, 52,103,108, 51, 50,105, 53, 51, 51, 54,105, 51, 
         53,106, 53, 50,105, 54, 53, 50, 52,108, 51, 52,104, 53, 52, 52, 53, 52, 54, 
         53, 50, 53, 52, 53, 53, 51, 52, 52, 53, 53, 52, 52, 52, 54, 51, 52, 53, 50, 
         52, 52, 56, 54, 51,103,106, 54, 51, 52, 50,105, 53, 53, 53, 52,106, 50, 53, 
         52, 53, 52, 51, 52, 51, 53, 54, 54, 53,101,104, 52, 54, 56, 51,103,103, 53, 
         53, 50, 55, 55, 52,102,105, 55, 52, 52, 50,102, 51, 50, 51, 50,102
     };
