...
//V13.X - Trial to include Mazda 3 2023
//V13.2 - Added support for WEMOS ESP32 D1 mini and Wifi + MQTT output
//      - Added support for Audi and BMW 5 Series


#define VERSION "13.2"  //under development!!!
...
//  Serial.println(SS); 
  ...
  #elif Mazda3
     Serial.println (F(" and Mazda 3 BDEL-37-140 TPMS sensor"));     
  #elif Hyundai_i35
  ...
  #elif Hyundai_i35
     Serial.println(F(" and Hyundai i35 TPMS sensor"));
  #elif Schrader_C1100
     Serial.println(F(" and Hyundai Tucson TPMS sensor"));
  #elif Schrader_A9054100
     Serial.println(F(" and Smart ForTwo TPMS sensor"));
  #elif Subaru
     Serial.println(F(" and Subaru TPMS TPMS sensor")); 
  #elif Audi_Etron
     Serial.println(F(" and Audi E-tron TPMS sensor"));
  #elif BMW5
     Serial.println(F(" and BMW 5 Series TPMS sensor"));
  #else
     Serial.println(F("Not specified"));
  #endif
  ...
  void loop() 
  {
    ...
    UpdateTimers(); 
      ...
      if (TimingsAreValid == true)
      {
        ...
        ClearRXBuffer();
        EnableRXInterrupts();  //re-enable interrupts & reset TimingsAreValid flag
